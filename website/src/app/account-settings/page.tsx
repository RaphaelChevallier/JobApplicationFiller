...
export default async function AccountSettingsPage({ searchParams }: { searchParams: { message?: string, error?: string } }) {
  ...
  return (
    <div className="flex flex-col items-center pt-16 pb-8 bg-gray-200 dark:bg-gray-950 min-h-screen">
      <div className="w-full max-w-4xl mx-auto px-4 md:px-8 space-y-6">
        ...
        <div className="space-y-6">
          {/* Subscription Card */}
          <div className="p-6 bg-blue-50/50 dark:bg-indigo-950/70 backdrop-blur-lg rounded-xl border border-blue-200/40 dark:border-indigo-800/50 shadow-xl">
          ...
          <div className="p-6 bg-blue-50/50 dark:bg-indigo-950/70 backdrop-blur-lg rounded-xl border border-blue-200/40 dark:border-indigo-800/50 shadow-xl">
            ...
            <div className="text-center p-4">
              ...
              <button className="mt-3 px-4 py-2 text-sm font-medium bg-white/10 dark:bg-black/20 backdrop-blur-md border border-white/20 dark:border-white/10 text-gray-800 dark:text-white rounded-lg shadow-lg hover:bg-white/30 dark:hover:bg-black/40 hover:shadow-xl transition-all duration-300 ease-in-out focus:ring-2 focus:ring-indigo-500/50 focus:outline-none cursor-pointer">
                Add Payment Method
              </button>
            </div>
          </div>
          ...
          <div className="p-6 bg-blue-50/50 dark:bg-indigo-950/70 backdrop-blur-lg rounded-xl border border-blue-200/40 dark:border-indigo-800/50 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                <button className="px-4 py-2 text-sm font-medium bg-white/10 dark:bg-black/20 backdrop-blur-md border border-white/20 dark:border-white/10 text-gray-800 dark:text-white rounded-lg shadow-lg hover:bg-white/30 dark:hover:bg-black/40 hover:shadow-xl transition-all duration-300 ease-in-out focus:ring-2 focus:ring-indigo-500/50 focus:outline-none cursor-pointer">
                  Change Password
                </button>
                <button className="px-4 py-2 text-sm font-medium bg-white/10 dark:bg-black/20 backdrop-blur-md border border-white/20 dark:border-white/10 text-gray-800 dark:text-white rounded-lg shadow-lg hover:bg-white/30 dark:hover:bg-black/40 hover:shadow-xl transition-all duration-300 ease-in-out focus:ring-2 focus:ring-indigo-500/50 focus:outline-none cursor-pointer">
